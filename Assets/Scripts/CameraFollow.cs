...
public class CameraFollow : MonoBehaviour {
    ...
    private float halfWidth, halfHeiht;
	...
	void Update () {
        ...
        float clampY = Mathf.Clamp(this.transform.position.y, minLimits.y + halfHeiht, maxLimits.y - halfHeiht);
    ...
    public void ChangeLimits(BoxCollider2D newCameraLimits)
    {
        ...
        halfHeiht = halfWidth / Screen.width * Screen.height;
    }
}
